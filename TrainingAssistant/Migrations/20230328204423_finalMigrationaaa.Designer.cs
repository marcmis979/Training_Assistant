...
namespace TrainingAssistant.Migrations
{
    ...
    [Migration("20230328204423_finalMigrationaaa")]
    partial class finalMigrationaaa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asystent_Treningowy.Models.Training", b =>
                {
                    b.HasOne("Asystent_Treningowy.Models.TrainingPlan", "Tp")
                        .WithMany("Trainingies")
            ...
            modelBuilder.Entity("Asystent_Treningowy.Models.TrainingPlan", b =>
                {
                    b.HasOne("Asystent_Treningowy.Models.User", "User")
                        .WithOne("TrainingPlan")
                        .HasForeignKey("Asystent_Treningowy.Models.TrainingPlan", "IdPlan")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
